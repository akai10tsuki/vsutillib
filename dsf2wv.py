...
def main():
    ...
    for d in args.directory:
        ...
        msg = 'Working in \n\nDirectory: [{}]\nWildcard:  {}\n\n'.format(str(Path(d).resolve()), wildcard)
        printToConsoleAndFile(logFile, msg)

        filesList = utils.getFileList(d, wildcard=wildcard, fullpath=True, recursive=recursive)
